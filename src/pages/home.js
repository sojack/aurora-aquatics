  ...
  <Layout>
    ...
    <main>
      <section className="grid">
        <div className="gridItem section1">
          <a href="#membership">Membership</a>
        </div>
        <div className="gridItem section2">
          <a href="#">Upcoming Events</a>
        </div>
        <div className="gridItem section3">
          <a href="#">Current Opportunity</a>
        </div>
        <div className="gridItem section4">
          <a href="#">Key Messages</a>
        </div>
        <div className="gridItem section5">
          <a href="#">Q&amp;A</a>
        </div>
      </section>
